namespace PokemonPRNG.LCG32.AlternativeLCG
{
    public static class AlternativeLCGExtension
    {
        private static readonly LCG32 lcg = new LCG32(0x6C078965, 1, 0x9638806D, 0x69C77F93);
        /// <summary>
